...
namespace IlluminationInvariantFaceRecognitionSystem
{
    class DatabaseManager
    {
        ...
        private static SqlConnection conect = new SqlConnection(ConfigurationManager.ConnectionStrings["IlluminationInvariantFaceRecognitionSystem.Properties.Settings.IKYDataBaseConnectionString"].ConnectionString);
        ...
        public static int GetUserCount()
        {
            ...
            //SqlConnection con = new SqlConnection("IlluminationInvariantFaceRecognitionSystem.Properties.Settings.IKYDataBaseConnectionString");
